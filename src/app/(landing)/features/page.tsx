  ...
  return (
    <div className="bg-white pt-24">
      ...
      <section className="py-20 bg-[#F8FAFC] text-center border-b border-slate-200/80 relative overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[250px] w-[250px] bg-[#159DFC]/4 rounded-full blur-[80px] pointer-events-none" />
        <div className="max-w-3xl mx-auto px-6 relative z-10 space-y-6">
          ...
          <div className="pt-2">
            <Link
              href="/pricing"
              className="inline-flex items-center gap-2 bg-[#0F172A] hover:bg-[#1E293B] text-white text-xs font-extrabold px-8 py-3 rounded-xl transition-all shadow-md hover:scale-[1.02]"
            >
