...
export default function HomePage() {
  ...
  return (
    <div className="bg-white">
                ...
                <div className="space-y-2.5 pt-2">
                  ...
                  >
                    <div>
                      ...
                      <span className="block text-[10px] text-amber-750 font-extrabold mt-0.5 flex items-center gap-1">
      ...
      {/* 4. Final Onboarding CTA Section */}
