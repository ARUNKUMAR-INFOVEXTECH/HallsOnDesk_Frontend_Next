    ...
    <div className="bg-white">
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {previewFeatures.map((feat, i) => (
              <div 
                key={i}
                className="p-8 rounded-3xl border border-slate-200/80 bg-[#F8FAFC] hover:bg-white hover:border-[#159DFC]/40 transition-all duration-300 shadow-sm hover:shadow-md"
              >
                ...
                <h3 className="font-extrabold text-[#0F172A] text-sm tracking-tight mb-2">{feat.title}</h3>
          ...
          <div className="text-center">
            <Link 
              href="/features"
              className="inline-flex items-center gap-2 text-xs font-extrabold text-[#159DFC] hover:text-[#002499] transition-colors py-2 group"
            >
      ...
      <section className="py-20 bg-[#F8FAFC] border-b border-slate-200/80 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center space-y-6">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-[#159DFC]/10 border border-[#159DFC]/25 rounded-full text-[10px] font-bold text-[#002499] uppercase tracking-widest backdrop-blur-sm">
          ...
          <div className="pt-4 flex flex-col sm:flex-row gap-4 items-center justify-center">
            <Link
              href="/pricing"
              className="w-full sm:w-auto bg-[#0F172A] hover:bg-[#1E293B] text-white text-xs font-extrabold px-7 py-3 rounded-xl transition-all shadow-md hover:scale-[1.02] flex items-center justify-center gap-1.5"
            >
            ...
            <button
              ...
              className="w-full sm:w-auto bg-white border border-slate-250 text-slate-700 hover:text-[#0F172A] text-xs font-bold px-7 py-3 rounded-xl transition-all hover:scale-[1.02] shadow-sm"
            >
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 max-w-4xl mx-auto">
            ...
            <div className="p-8 rounded-3xl border border-slate-200/80 bg-[#F8FAFC] space-y-5 shadow-sm">
              <div className="flex gap-1 text-[#159DFC]">
                {[...Array(5)].map((_, i) => (
              ...
              <div className="flex items-center gap-3 pt-3 border-t border-slate-200/60">
                <div className="h-8 w-8 rounded-full bg-slate-200 text-[#0F172A] flex items-center justify-center font-bold text-xs uppercase shrink-0">
                  S
                </div>
                <div>
                  <span className="font-extrabold text-slate-800 text-[11px] block leading-none">Sundaram P.</span>
                  <span className="text-[9px] text-slate-450 block mt-1 font-semibold">Owner, Sundar Mahal Palace • <span className="text-[#159DFC] font-bold">Madurai</span></span>
                </div>
              </div>
            </div>
            ...
            <div className="p-8 rounded-3xl border border-slate-200/80 bg-[#F8FAFC] space-y-5 shadow-sm">
              ...
              <div className="flex items-center gap-3 pt-3 border-t border-slate-200/60">
                ...
                <div>
                  ...
                  <span className="text-[9px] text-slate-450 block mt-1 font-semibold">Manager, Sri Balaji Mandapam • <span className="text-[#159DFC] font-bold">Chennai</span></span>
                </div>
              </div>
            </div>
          </div>
