  ...
  return (
    <div className="w-full bg-slate-950 border border-slate-800 rounded-2xl shadow-2xl p-1 md:p-2 overflow-hidden select-none text-left">
      ...
      <div className="flex h-[420px] md:h-[500px] bg-[#F8FAFC] overflow-hidden">
        ...
        {/* 1. Left Sidebar Mockup (Dark Navy bg-[#0A192F] exactly like real app) */}
        <aside className="hidden md:flex flex-col w-44 bg-[#0A192F] border-r border-[#1E2E44] text-slate-400 shrink-0">
          {/* Logo Section */}
          <div className="p-3.5 border-b border-[#1E2E44] space-y-3">
            <div className="flex items-center">
              <img src="/logo.png" alt="Infovex Halls Logo" className="h-6 w-auto object-contain" />
            </div>
            {/* Venue switcher mimic */}
            <div className="flex items-center justify-between px-2 py-1.5 bg-[#071426]/70 border border-[#1E2E44] rounded-lg text-[9px] font-bold text-slate-300">
          ...
          <nav className="flex-1 p-2 space-y-4 overflow-y-auto">
            <div className="space-y-1">
              <span className="px-2.5 text-[7px] font-black text-slate-500 uppercase tracking-widest block mb-1">
                Venue Workspace
              </span>
              {navItems.map((item, i) => (
                <div
                  ...
                  className={`flex items-center gap-2.5 px-2.5 py-1.5 rounded-lg text-[9.5px] cursor-pointer transition-all ${
                    item.active
                      ? 'bg-[#EE9B00]/10 text-[#EE9B00] border-l border-[#EE9B00] font-bold'
          ...
          <div className="p-3 border-t border-[#1E2E44] bg-[#071426]/40 flex items-center justify-between">
            <div className="flex items-center gap-2 overflow-hidden">
              <div className="h-6.5 w-6.5 rounded-full bg-[#EE9B00]/20 text-[#EE9B00] flex items-center justify-center font-bold text-[9px] shrink-0 border border-[#EE9B00]/30">
                S
              </div>
              <div className="overflow-hidden leading-none">
                <span className="font-bold text-[9px] text-slate-200 block truncate">Suresh Kumar</span>
                <span className="text-[7.5px] text-slate-500 block truncate mt-0.5 capitalize">Owner</span>
              </div>
            </div>
            <LogOut className="h-3.5 w-3.5 text-slate-500 hover:text-red-400 cursor-pointer" />
          </div>
        </aside>
          ...
          <header className="h-10 bg-white border-b border-slate-200 px-4 flex items-center justify-between shrink-0">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative">
                ...
                <span className="absolute -top-1 -right-1 h-2 w-2 rounded-full bg-[#EE9B00]" />
              </div>
              <div className="h-6 w-6 rounded-full bg-indigo-50 border border-indigo-100 flex items-center justify-center font-bold text-[9px] text-[#0A2540]">
                S
              </div>
            </div>
          </header>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
              <div className="bg-white border border-slate-200 rounded-xl p-3.5 shadow-sm space-y-2">
                ...
                <div className="flex justify-between items-baseline">
                  <span className="text-base font-extrabold text-[#0A2540] font-mono">32</span>
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-3.5 shadow-sm space-y-2">
                ...
                <div className="flex justify-between items-baseline">
                  <span className="text-base font-extrabold text-[#0A2540] font-mono">₹1,84,500</span>
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-3.5 shadow-sm space-y-2">
                ...
                <div className="flex justify-between items-baseline">
                  <span className="text-base font-extrabold text-[#0A2540] font-mono">8 leads</span>
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-3.5 shadow-sm space-y-2">
                ...
                <div className="flex justify-between items-baseline">
                  <span className="text-base font-extrabold text-[#0A2540] font-mono">₹45,200</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
              ...
              <div className="lg:col-span-7 bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden flex flex-col justify-between">
                <div className="px-4.5 py-2.5 border-b border-slate-100 flex items-center justify-between">
                  ...
                  <span className="text-[8.5px] font-bold text-[#EE9B00] hover:underline cursor-pointer">Calendar Log</span>
                </div>
                <div className="overflow-x-auto">
                  <table className="min-w-full text-left text-[9px] font-medium text-slate-600">
                    ...
                    <tbody className="divide-y divide-slate-100">
                      <tr className="h-9">
                        <td className="px-4 text-[#0A2540] font-bold">12 Jun 2026</td>
                      ...
                      <tr className="h-9">
                        <td className="px-4 text-[#0A2540] font-bold">18 Jun 2026</td>
              ...
              <div className="lg:col-span-5 grid grid-cols-1 gap-4">
                ...
                <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-sm flex flex-col justify-between">
                  <div className="flex justify-between items-center mb-3 text-[9.5px] font-extrabold text-slate-700 uppercase tracking-wider">
                    ...
                    <Activity className="h-3.5 w-3.5 text-[#EE9B00] shrink-0" />
                  </div>
                  
                  <div className="relative pl-2.5 border-l border-slate-200 space-y-2.5 ml-1 text-[8.5px]">
                    <div className="relative leading-tight">
                      <div className="absolute -left-[13.5px] h-1.5 w-1.5 rounded-full bg-[#EE9B00] border border-white mt-0.5" />
