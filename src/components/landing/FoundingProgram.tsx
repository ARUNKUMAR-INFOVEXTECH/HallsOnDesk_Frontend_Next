...
export default function FoundingProgram({ onBookDemoClick }: FoundingProgramProps) {
  ...
  return (
    <section className="py-28 bg-white border-b border-slate-200/80 text-slate-800 relative overflow-hidden" id="founding-program">
      ...
      <div className="absolute -top-48 -right-48 h-96 w-96 bg-[#EE9B00]/2 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-[#0A2540] leading-tight font-display">
              Co-Design the Future of Mandapam Operations
            </h2>
            
            <p className="text-sm text-slate-500 leading-relaxed font-semibold">
              We are expanding across Tamil Nadu. The first <span className="text-[#EE9B00] font-extrabold">20 partner venues</span> get lifetime onboarding privileges, permanently locked subscription rates, and custom feature developments designed specifically for their business.
            </p>
            ...
            <div className="space-y-4 pt-2">
              {benefits.map((benefit, i) => (
                <div key={i} className="flex items-start gap-3 text-xs">
                  <div className="h-5.5 w-5.5 rounded-full bg-[#EE9B00]/10 border border-[#EE9B00]/25 text-[#EE9B00] flex items-center justify-center shrink-0 mt-0.5 shadow-md">
            ...
            <div className="pt-4">
              <button
                ...
                className="py-3 px-7 rounded-xl text-xs font-extrabold bg-[#EE9B00] hover:bg-[#D48A00] text-[#0A2540] transition-all duration-200 cursor-pointer inline-flex items-center gap-2 shadow-lg hover:shadow-[#EE9B00]/20 hover:scale-[1.03] active:scale-95 border border-[#EE9B00]/25 shadow-[#EE9B00]/10"
              >
          ...
          <div className="lg:col-span-5 bg-[#F8FAFC] border border-slate-200/80 backdrop-blur-md rounded-2xl p-8 shadow-xl relative">
            <div className="absolute top-0 right-0 w-24 h-24 bg-[#EE9B00]/3 rounded-full blur-xl pointer-events-none" />
            
            <h3 className="font-bold text-sm border-b border-slate-200/80 pb-3.5 mb-5 flex items-center gap-2 text-[#0A2540]">
              <MapPin className="h-4.5 w-4.5 text-[#EE9B00] shrink-0" />
            ...
            <div className="grid grid-cols-2 gap-3">
              {focusDistricts.map((district, idx) => (
                <div
                  key={idx}
                  className="flex items-center gap-2.5 px-3.5 py-3 bg-white border border-slate-200/60 hover:bg-slate-50 rounded-xl text-xs font-semibold text-slate-650 transition-all duration-200 cursor-default hover:border-[#EE9B00]/25"
                >
                  <span className="h-1.5 w-1.5 bg-[#EE9B00] rounded-full shrink-0" />
                  {district}
                </div>
              ))}
            </div>
